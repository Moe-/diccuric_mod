...
//************** Neu für Diccurice - Harri ****************

//////////////////////////////////////////////////////////////////////////
//	C_NpcIsDicArena
//	=============
//	Ermittelt, ob der NSC eine Arenamonster oder Haustier ist:
//	->	NPC_Arenamonster -> TRUE
//
//////////////////////////////////////////////////////////////////////////
func int 	C_NpcIsDicArena(var C_NPC slf)
{
	PrintDebugNpc	(PD_ZS_DETAIL, "C_NpcIsDicArena");
	...
	if	(npcInstance == Arena_Scavenger	)
	||	(npcInstance == Arena_Molerat	) 
	||	(npcInstance == Arena_Lurker	) 
	||	(npcInstance == Arena_Wolf		) 
	||	(npcInstance == Arena_Blutfliege)
	||	(npcInstance == Arena_Ork		)
	||	(npcInstance == Haus_Scavenger  )	
	||	(npcInstance == Haus_Molerat    )	
	||	(npcInstance == Haus_Lurker     )	
	||	(npcInstance == Haus_Wolf       )	
	||	(npcInstance == Haus_Blutfliege )	
	||	(npcInstance == Haus_Gobbo      )	
	||	(npcInstance == Haus_Ratte      )	
	||	(npcInstance == Haus_Minecrawler)	
	||	(npcInstance == Haus_Skeleton   )	
	||	(npcInstance == Haus_Zombie     )
	||	(npcInstance == JngWaran		)			// extra noch wegen BaremQest
	||	(npcInstance == Spint			)			// damit ihn keiner killt
