...
func void B_AssessEnemy()
{
	...
	PrintGlobals			(PD_ZS_CHECK);
		...
		//-------- Monster ist Arenamonster --------		- Harri
		if ( C_NpcIsDicArena(other) )
		{
			PrintDebugNpc	(PD_ZS_CHECK, "...NSC ist Arenamonster" );			
			return;
		};
		
		if Npc_IsInState(self, ZS_GuidePC)			// versuch GuidePC davon abzuhalten jeden Feind zu jagen -Harri
		&& ((Npc_GetDistToNpc(self, other) > 600)
		|| Npc_IsInState(other, ZS_Flee))
		{
			...
			PrintDebugNpc	(PD_ZS_CHECK, "...Npc ist GuidePC" );
			return;
		};
