...
func void B_MM_AssessEnemy()
{
	...
	&& (Hlp_GetInstanceID(other) != Hlp_GetInstanceID(DIC_2028_Barem)
	&& Hlp_GetInstanceID(self) != Hlp_GetInstanceID(JngWaran))			//SN 08.01.01: Vermeidung von Entdeckung des Spieler durch Wände hindurch
	{
		...
		else if (C_PreyToPredator(self,other)) || (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(Spint))	// Beute flieht immer vor Jäger
		{
			Npc_SetTarget 	(self,other);
			Npc_ClearAIQueue(self);
...
func void B_MM_ReactToDamage ()
{
	...
	if (C_PreyToPredator(self,other)) || (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(Spint))
	{
...
func void B_MM_ReactToCombatDamage ()
{
	...
	|| Hlp_GetInstanceID(self) == Hlp_GetInstanceID(PruefungOrk)))
	{
		PrintScreen		("Treffer!", -1, 30, _STR_FONT_ONSCREEN, 9 );
	};
...
func void B_MM_AssessSurprise()					// 	aus G2 -Harri
	{
...
func void ZS_MM_Attack ()
{
	...
	|| (Hlp_GetInstanceID(other) == Hlp_GetInstanceID(DIC_2028_Barem)
	&& Hlp_GetInstanceID(self) == Hlp_GetInstanceID(JngWaran))
	{
	...
	// ------ lokale Wahrnehmung für verwandelten SC ------					aus G2 -Harri
...
func int ZS_MM_Attack_Loop ()
{
	PrintDebugNpc		(PD_MST_LOOP, "ZS_MM_Attack_Loop");
		...
		//-------- Barem und seine Warane --------
	if (other.aivar[AIV_INVINCIBLE])
	|| (Hlp_GetInstanceID(other) == Hlp_GetInstanceID(DIC_2028_Barem)
	&& Hlp_GetInstanceID(self) == Hlp_GetInstanceID(JngWaran))
		{
			PrintDebugNpc			(PD_ZS_CHECK,	"Jnge Warane - meine Feunde ..." );
			B_FullStop 				(self);
			return 					1;
		};
