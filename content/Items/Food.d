...
const int	Value_Reisschnaps	=	50;		const int	HP_Reisschnaps		=	3;
...
const int	Value_Velayis		=	8;		const int	HP_Velayis			=	5;	// Harri - edit
...
const int	Value_Trollkirsche	=	500;		const int	HP_Trollkirsche		=	-20;
...
{	
	...
	FUNC VOID UseMuttonRaw()
		{
		if (Npc_GetDistToWP(self,"SEE_VOR_STADT_12") <= 750)
			{
			//AI_OutputSVM_Overlay (hero,hero,"FleischEssen_15_00"); //Vielleicht sollte ich aufhören, das Fleisch zu essen und mir damit was besseres anfangen?
			//AI_StandUpQuick (hero);
			PrintScreen	("Ob ich hier das Fleisch essen sollte?!?", -1,-1,"font_old_20_white.tga",3);
			};
...
{	
	...
	TEXT[5]				= NAME_Value;					COUNT[5]	= Value_Waldbeeren;
		...
		func void UseBerrys ()
		{
			...
			Bonus_Waldbeeren = Bonus_Waldbeeren +1;
			if Bonus_Waldbeeren == 40
			{
				Bonus_Waldbeeren = 0;
...
{	
	...
	TEXT[5]				= NAME_Value;					COUNT[5]	= Value_Flammendorn;
		...
		func void Useflame ()
		{
			...
			Bonus_Flammendorn = Bonus_Flammendorn + 1;
			if Bonus_Flammendorn == 25
			{
				Bonus_Flammendorn = 0;
...
{	
	...
	visual 				=	"ItFo_Plants_Velayis_01.3ds";		// Harri - neu
	material 			=	MAT_WOOD;
	...
	TEXT[2]				= NAME_Bonus_Mana;				COUNT[2]	= HP_Velayis;
	TEXT[5]				= NAME_Value;					COUNT[5]	= Value_Velayis;
		...
		{	
			...
			Npc_ChangeAttribute	(self,	ATR_MANA,	HP_Velayis);		// Harri - neu
...
{	
	...
	visual 				=	"ItFo_Plants_RavenHerb_02.3ds";
	material 			=	MAT_WOOD;
...
{	
	...
	visual 				=	"ItFo_Plants_Stoneroot_03.3ds";
	material 			=	MAT_WOOD;
	on_state[0]			=   Useroot;
	scemeName			=	"FOOD";
...
{	
	...
	visual 				=	"ItFo_Plants_Stoneroot_02.3ds";
	material 			=	MAT_WOOD;
	on_state[0]			=   Useroot2;
	scemeName			=	"FOOD";
