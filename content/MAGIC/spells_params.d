...
const int	SPL_SENDCAST_TRF_WOLF		=	5;
...
const int	SPL_SENDCAST_SUMMONRAZOR	=	35;
const int	SPL_SENDCAST_SUMMONHARPIE	=	35;
...
const int	SPL_SENDCAST_HEILEWALA		=	5;
...
// Added by Moe
instance Spell_HeileWala (C_Spell_Proto)
	{
	time_per_mana			= 100;
	spelltype				= SPELL_NEUTRAL;
	targetCollectAlgo		= TARGET_COLLECT_FOCUS;
...
INSTANCE Spell_Razor	(C_Spell_Proto)
{
	time_per_mana			= 500;
	spelltype 				= SPELL_BAD;
	targetCollectAlgo		= TARGET_COLLECT_NONE;
...
INSTANCE Spell_Harpie	(C_Spell_Proto)
{
	time_per_mana			= 500;
	spelltype 				= SPELL_BAD;
	targetCollectAlgo		= TARGET_COLLECT_NONE;
