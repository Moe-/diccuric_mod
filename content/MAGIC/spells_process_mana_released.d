...
// Spells, die abgebrochen werden, wenn beim loslassen der Taste noch nicht gecastet 
	...
	if (Npc_GetActiveSpell(self) == SPL_WALAHEILEN			)	{	return  SPL_SENDSTOP;	};
	if (Npc_GetActiveSpell(self) == SPL_SUMMONRAZOR		)	{	return	SPL_SENDSTOP;	};
	if (Npc_GetActiveSpell(self) == SPL_SUMMONHARPIE	)	{	return	SPL_SENDSTOP;	};
};