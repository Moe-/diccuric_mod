...
/*******************************************************************************************/
func void B_AssessMagic_HeileWala()
{
	PrintDebugNpc( PD_MAGIC, "...HeileWala" );	

	//	Damit andere NSCs den Angriff wahrnehmen können
	//Npc_SendPassivePerc	(self, PERC_ASSESSFIGHTSOUND, self, other);
	if (Npc_GetDistToWP(self,"LOCATION_11_15") <= 500)
			{
			WalaZustand = 1;
...
func void B_AssessMagic ()
{
	...
	else if ( Npc_GetActiveSpell	(other) == SPL_WALAHEILEN		)		{	B_AssessMagic_HeileWala		();	};
...
//	 ( Npc_GetActiveSpell 	(other) == SPL_TELEPORT6	)			{	B_AssessMagic_TELEPORT6();		} 
