...
instance ORC_Priest_6 (Npc_Default)
{
	//-------- primary data --------
	name 		=		"Ostahelper";
	Npctype 	=		NPCTYPE_FRIEND;
	...
	//------------- ai -------------
	daily_routine	=	Rtn_PreStart_3000;
	senses			=	SENSE_SEE|SENSE_HEAR|SENSE_SMELL;
	fight_tactic	=	FAI_HUMAN_MAGE;
	aivar[AIV_SPECIALCOMBATDAMAGEREACTION] = TRUE;
	aivar[AIV_TALKBEFOREATTACK] = TRUE;
...
FUNC VOID Rtn_PreStart_3000 ()
{
	TA_Intercept	(07,00,12,00,"GR3_00");
	TA_Intercept 	(12,00,07,00,"GR3_00");
};
// ****************************************************************
// ------------------ Orkpriester 7 -----------------------------
// ****************************************************************

instance ORC_Priest_7 (Npc_Default)
{
	//-------- primary data --------
	name 		=		"Testhelper";
	Npctype 	=		NPCTYPE_FRIEND;
	...
	//------------- ai -------------
	daily_routine	=	Rtn_PreStart_3001;
	senses			=	SENSE_SEE|SENSE_HEAR|SENSE_SMELL;
	fight_tactic	=	FAI_HUMAN_MAGE;
	aivar[AIV_SPECIALCOMBATDAMAGEREACTION] = TRUE;
	aivar[AIV_TALKBEFOREATTACK] = TRUE;
...
FUNC VOID Rtn_PreStart_3001 ()
{
	TA_Intercept	(07,00,12,00,"PF_07");
	TA_Intercept 	(12,00,07,00,"PF_07");
};