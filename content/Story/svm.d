...
{
	// ------ B_Say_AttackReason -----------------------------------------------------------------------------------------
	DieMortalEnemy					=	"SVM_16_DieMortalEnemy"					;//Jetzt bist du dran!
...
//	EnemyKilled					=	"SVM_16_EnemyKilled"				;//Das war's für dich, Junge.
	DieMonster					=	"SVM_16_DieMonster"					;//Ein Mistvieh weniger!
...
//	StupidBeastKilled				=	"SVM_16_StupidBeastKilled"			;//So ein saublödes Vieh!
	NeverTryThatAgain				=	"SVM_16_NeverTryThatAgain"				;//Leg dich nie wieder mit mir an!
...
//	ThereIsNoFightingHere				=	"SVM_16_ThereIsNoFightingHere"		;//Hier wird nicht gekämpft, klar!? Lass dir das eine Lehre sein, okay?
	// ------ C_WantToFlee -------------------------------------------------------------------------------------------------
	YesYes						=	"SVM_16_YesYes"						;//Tu mir nichts!
	ShitWhatAMonster				= 	"SVM_16_ShitWhatAMonster"						;//Nichts wie weg!
	// ------ C_WantToCallGuardsToFight --------------------------------------------------------------------------------------
	Alarm						=	"SVM_16_Alarm"					;//ALARM!
	IntruderAlert					=	"SVM_16_IntruderAlert"			;//WACHE!
	Help						=	"SVM_16_Help"					;//Hilfe!
	// ------ B_AssessMurder -----------------------------------------------------------------------------------------------
	ItWasAGoodFight					=	"SVM_16_ItWasAGoodFight"			;//(ruft zu) Gut gemacht!
	CheerFriend					= 	"SVM_16_CheerFriend"				;//(ruft) Ja, mach das Schwein fertig!
	// ------ B_AssessTalk -----------------------------------------------------------------------------------------------
...
//	NotBad						= 	"SVM_16_NotBad"					;//(anerkennend) Nicht schlecht ...
	CheerFriend					=	"SVM_16_CheerFriend03"			;//Mach ihn fertig!
	CheerFight					=	"SVM_16_CheerFriend01"			;//Hau drauf!
