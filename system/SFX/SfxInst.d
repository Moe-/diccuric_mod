...
/* Barriere */	INSTANCE MFX_Barriere_Ambient			(C_SFX_DEF) {file= "NOSOUND.wav";		vol = 0;			};
...
// ***********************                                                                          				
// Harri - Neues - aus G2 gemobst :)                                                                           				
// *********************** 

/* Diverses */

				INSTANCE Dic_Music 						(C_SFX_DEF) {file= "dic_musik.wav"; 				vol =100;			};



/* Humans */

				INSTANCE MOB_RAKE						(C_SFX_DEF) {file= "MOB_RAKE_01.wav";				vol = 60;			};
				INSTANCE MOB_RAKE_A1					(C_SFX_DEF) {file= "MOB_RAKE_02.wav";				vol = 60;			};
				INSTANCE MOB_RAKE_A2					(C_SFX_DEF) {file= "MOB_RAKE_03.wav";				vol = 60;			};
				INSTANCE MOB_RAKE_A3					(C_SFX_DEF) {file= "MOB_RAKE_04.wav";				vol = 60;			};



/* Ratte */
				INSTANCE RAT_AMBIENT					(C_SFX_DEF) {file= "RAT_Ambient_01.wav";			vol = 60;			};
				INSTANCE RAT_AMBIENT_A1 				(C_SFX_DEF) {file= "RAT_Ambient_02.wav";			vol = 60;			};
				INSTANCE RAT_AMBIENT_A2 				(C_SFX_DEF) {file= "RAT_Ambient_03.wav";			vol = 60;			};
				INSTANCE RAT_AMBIENT_A3 				(C_SFX_DEF) {file= "RAT_Ambient_04.wav";			vol = 60;			};
				INSTANCE RAT_AMBIENT_A4 				(C_SFX_DEF) {file= "RAT_Ambient_05.wav";			vol = 60;			};
				INSTANCE RAT_AMBIENT_A5 				(C_SFX_DEF) {file= "nosound.wav";				vol = 0;			};
				INSTANCE RAT_AMBIENT_A6 				(C_SFX_DEF) {file= "nosound.wav";				vol = 0;			};
				INSTANCE RAT_AMBIENT_A7 				(C_SFX_DEF) {file= "nosound.wav";				vol = 0;			};
				INSTANCE RAT_AMBIENT_A8 				(C_SFX_DEF) {file= "nosound.wav";				vol = 0;			};
				INSTANCE RAT_AMBIENT_A9 				(C_SFX_DEF) {file= "nosound.wav";				vol = 0;			};
				INSTANCE RAT_Attack 					(C_SFX_DEF) {file= "RAT_Attack_01.wav";				vol = 100;			};
				INSTANCE RAT_Attack_A1 					(C_SFX_DEF) {file= "RAT_Attack_02.wav";				vol = 100;			};
				INSTANCE RAT_Attack_A2 					(C_SFX_DEF) {file= "RAT_Attack_03.wav";				vol = 110;			};
				INSTANCE RAT_Die 					(C_SFX_DEF) {file= "RAT_DEAD_01.WAV";				vol = 110;			};
				INSTANCE RAT_EAT 					(C_SFX_DEF) {file= "RAT_EAT_01.WAV";				vol = 110;			};
				INSTANCE RAT_EAT_A1					(C_SFX_DEF) {file= "RAT_EAT_02.WAV";				vol = 110;			};
				INSTANCE RAT_Hurt  					(C_SFX_DEF) {file= "RAT_Hurt_01.wav";				vol = 90;			};
				INSTANCE RAT_Hurt_A1 					(C_SFX_DEF) {file= "RAT_Hurt_02.wav";				vol = 90;			};
				INSTANCE RAT_Hurt_A2  					(C_SFX_DEF) {file= "RAT_Hurt_03.wav";				vol = 90;			};
				INSTANCE RAT_EatWarn 					(C_SFX_DEF) {file= "RAT_EATWARN_01.WAV";			vol = 110;			};

/* Wolf's gejaule */	
				INSTANCE WOLFJAUL1					(C_SFX_DEF) {file= "Wolfjaul1.wav";				vol = 90;			};
				INSTANCE WOLFJAUL2					(C_SFX_DEF) {file= "Wolfjaul2.wav";				vol = 90;			};
...
/* Heal in H08 */		INSTANCE Heal_H08				        (C_SFX_DEF) {file= "Heal_H08.wav";				vol = 127;			};      
